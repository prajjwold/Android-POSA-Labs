...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent downloadService1=DownloadIntentService.makeIntent(getApplicationContext(), handler, getUrlString());
        	startService(downloadService1);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent downloadService2=ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, getUrlString());
            startService(downloadService2);
